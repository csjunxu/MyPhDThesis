...
However, in each of the camera we use in our dataset, we capture images with 5 different ISOs, e.g., 800, 1600, 3200, 6400, and 12800. With the increasing of the ISO, the noise levels will also increase at the same scene we capture. Hence, our dataset is more comprehensive at the noise levels the the previous datasets.
