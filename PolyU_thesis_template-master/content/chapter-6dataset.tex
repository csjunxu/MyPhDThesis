...
\textbf{Limited Camera Brands}: The RENOIR dataset \cite{RENOIR2014} contains the Canon (T3i and S90) and the Nikon D700 for image collection. This dataset only contains one camera brand and one mobile brand. The dataset \cite{crosschannel2016} contains the Canon (5D) and Nikon (D600 and D800). The DND dataset \cite{dnd2017} employs cameras of Sony (A7R and RX100 IV),  Olympus (E-M10), and Huawei (Nexus 6P). In summary, the datasets of \cite{RENOIR2014,crosschannel2016} datasets only contain Canon and Nikon 
