...
\textbf{Limited Camera Brands}: In the RENOIR dataset \cite{RENOIR2014}, the authors use two different camera brands such as Canon (T3i and S90), and Nikon D700 for image collection. In the dataset \cite{crosschannel2016}, the authors use the Canon (5D) and Nikon (D600 and D800). The DND dataset \cite{dnd2017} employs cameras of Sony (A7R and RX100 IV),  Olympus (E-M10), and Huawei (Nexus 6P). In summary, the datasets of \cite{RENOIR2014,crosschannel2016} datasets only contain two different (Canon and Nikon) cameras, while the dataset \cite{dnd2017} contains three different cameras.
