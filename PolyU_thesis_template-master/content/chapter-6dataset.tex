...
Since the images we captured are in very large size, we crop 100 smaller parts from the 40 scenes to evaluated the existing image denoising methods. Some examples of the cropped parts are listed in Figure \ref{fig6-3}. We can see that the cropped parts can represente the captured images in the whole dataset.
