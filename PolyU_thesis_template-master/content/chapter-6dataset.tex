...
The statistical peorperties of realistic noise has been thoroughly studied for CCD and CMOS image sensors. The realistic noise related to the CCD or CMOS sensors could be divided into five major sources. The first one is the shot noise. This inevitable source of noise is induced by the stochastic arrival process of photons to the sensor. which is termed shot noise and could be modeled as Possion distribution.
