...
As we have presented in the previous chapters, the image denoising tasks are very different in processing the synthetic additive white Gaussian noise (AWGN) and in processing the realistic noise. The realistic noise is signal dependent and will become much more complex when processed in the camera imaging pipeline, while the AWGN noise is independent of the signals. Hence, processing real noisy images is more challenging than the traditional AWGN noise.
