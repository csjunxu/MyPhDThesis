...
% **************************************************
\newcommand{\thesisTitle}{Patch Group Based Nonlocal Self-Similarity Prior Modeling \\for Image Denoising}
...
\input{content/chapter-2external} % INCLUDE: PGPD
\input{content/chapter-3guided}	% INCLUDE: guided
\input{content/chapter-4internallr} % INCLUDE: MCWNNM
\input{content/chapter-5internalsc} % INCLUDE: TWSC
\input{content/chapter-6dataset} % INCLUDE: a new dataset
\input{content/chapter-7conclusions} % INCLUDE: conclusion
\input{content/chapter-8appendix} % INCLUDE: appendix
\cleardoublepage
