...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/dataset/dnd/resize_br_TNRD_0001_1.png}}
{\footnotesize TNRD}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/dataset/dnd/resize_br_TWSC_0001_1.png}}
{\footnotesize TWSC}
\end{minipage}
}
