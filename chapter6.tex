...
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/dataset/dnd/resize_br_Mean_d600_iso3200_2_real.png}}
{\footnotesize Mean Image}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/dataset/dnd/resize_br_Noisy_d600_iso3200_2_real.png}}
{\footnotesize Noisy 33.77}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/dataset/dnd/resize_br_CBM3D_d600_iso3200_2_real.png}}
{\footnotesize CBM3D 35.06}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/dataset/dnd/resize_br_WNNM_d600_iso3200_2_real.png}}
{\footnotesize EPLL}
\end{minipage}
}
\subfigure{
...
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/dataset/dnd/resize_br_TRD_d600_iso3200_2_real.png}}
{\footnotesize MLP}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
...
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/dataset/dnd/resize_br_DnCNN_d600_iso3200_2_real.png}}
{\footnotesize DnCNN 34.48}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/dataset/dnd/resize_br_NC_d600_iso3200_2_real.png}}
{\footnotesize NC 36.70}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/dataset/dnd/resize_br_NI_d600_iso3200_2_real.png}}
...
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/dataset/dnd/resize_br_CCNoise_d600_iso3200_2.png}}
{\footnotesize PGPD}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
...
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/dataset/dnd/resize_br_TWSC_d600_iso3200_2.png}}
{\footnotesize TWSC \textbf{37.07}}
\end{minipage}
}
    \caption{Denoised images and PSNR (dB) results of the real-world noisy image \textsl{Nikon D600 ISO 3200 2} \cite{crosschannel2016} by different methods.\ The images are better to be zoomed in on screen.}
    \label{fig6-6}
\end{figure}
...
\caption{Denoised images and PSNR (dB)/SSIM results of the real-world noisy image \textsl{Canon80D 8 8 800 GO 11} \cite{crosschannel2016} by different methods.\ The images are better to be zoomed in on screen.}
    \label{fig6-7}
\end{figure}
