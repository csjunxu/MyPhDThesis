...
\caption{Denoised images and PSNR (dB)/SSIM results of the real-world noisy image \textsl{Canon80D 8 8 800 GO 11} \cite{crosschannel2016} by different methods.\ The estimated noise levels of R, G, and B channels are 1.5, 1.3, and 1.6, respectively.\ The images are better to be zoomed in on screen.}
    \label{fig6-7}
\end{figure}
