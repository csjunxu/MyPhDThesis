...
\begin{itemize}
\item The original methods such as CBM3D, EPLL, NCSR, WNNM, MLP, CSF, TNRD, DnCNN, and PGPD, which designed for additive whit Gaussian noise (AWGN), are not effective at processing the realistic noise in real-world noisy images captured by CCD or CMOS cameras;
