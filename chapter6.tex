...
\begin{itemize}
\item The methods (CBM3D, EPLL, NCSR, WNNM, MLP, CSF, TNRD, DnCNN, and PGPD) designed for additive whit Gaussian noise (AWGN) achieve lower PSNR and SSIM when compared to the methods proposed for real-world noisy image denoising;
