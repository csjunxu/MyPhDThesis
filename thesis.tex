...
\input{content/chapter-2external} % INCLUDE: literature-review
\input{content/chapter-3guided}	% INCLUDE: system
\input{content/chapter-4internallr} % INCLUDE: feature extraction
\input{content/chapter-5internalsc} % INCLUDE: real time system
\input{content/chapter-6dataset} % INCLUDE: real time system
