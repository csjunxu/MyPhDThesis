...
% **************************************************
\newcommand{\thesisTitle}{External and Internal Nonlocal Self-Similarity based Models \\for Image Denoising}
\newcommand{\thesisName}{Jun Xu}
...
\newcommand{\thesisFirstSupervisor}{Prof. David Zhang}
...
\input{content/chapter-1introduction} % INCLUDE: introduction
\input{content/chapter-2literaturereview} % INCLUDE: literature-review
\input{content/chapter-3external} % INCLUDE: literature-review
\input{content/chapter-4guided}	% INCLUDE: system
\input{content/chapter-5internallr} % INCLUDE: feature extraction
\input{content/chapter-6internalsc} % INCLUDE: real time system
\input{content/chapter-7dataset} % INCLUDE: real time system
\input{content/chapter-8conclusions} % INCLUDE: conclusion
\cleardoublepage
