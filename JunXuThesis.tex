...
% Marginal notes
\setlength{\marginparwidth}{.5in} % width of marginal notes
...
\vfill
\hspace{3in}\isdefinedsig{ }
\vfill
\hspace{3in}\isdefinedsigname{ }
\\
\vfill
\vfill
\vfill
...
\Large\begin{center}\textbf{Publications arising from the thesis}\end{center}\normalsize
