...
%
\chapter{A Trilateral Weighted Sparse Coding Scheme for Real-world Image Denoising}
...
Liu2008,noiseclinic,Zhu_2016_CVPR,crosschannel2016,neatimage}. Most of the existing methods \cite{ksvd,bm3d,cbm3d,lssc,ncsr,wnnm,epll,pgpd,mlp,csf,tnrd,dncnn} focus on additive white Gaussian noise (AWGN), which can be categorized into dictionary learning based methods \cite{ksvd}, nonlocal self-similarity based methods \cite{bm3d,cbm3d,lssc,ncsr,wnnm}, sparsity based methods \cite{ksvd,bm3d,cbm3d,lssc,ncsr}, low-rankness based methods \cite{wnnm}, generative learning based methods \cite{epll,pgpd}, and discriminative learning based methods \cite{mlp,csf,tnrd,dncnn}. However, the real-world noise in real-world images is much more complex than AWGN \cite{crosschannel2016} and varies with different cameras and camera settings (such as ISO, shutter speed, and aperture, etc.). Though have shown promising performance on AWGN noise removal, the above methods \cite{ksvd,bm3d,cbm3d,lssc,ncsr,wnnm,epll,pgpd,mlp,csf,tnrd,dncnn} will become much less effective when dealing with complex real-world noise.

In the past decade, several denoising methods for real-world noisy images have been developed \cite{cbm3d,Liu2008,noiseclinic,Zhu_2016_CVPR,
crosschannel2016,neatimage}. Among them, CBM3D \cite{cbm3d} is a representative method which applies the benchmark BM3D method \cite{bm3d} to each channel of the luminance-chrominance space of the noisy image. Liu et al. \cite{Liu2008} proposed to estimate the noise via a ``noise level function'' and remove the noise for each channel of the real image. However, processing each channel separately would often achieve unsatisfactory performance and generate artifacts. The methods \cite{noiseclinic,Zhu_2016_CVPR} perform image denoising by concatenating the patches of RGB channels into a vector. However, the concatenation does not consider the different noise statistics among different channels. The method in \cite{crosschannel2016} models the noise in a noisy image as multivariate Gaussian and performs denoising by the Non-local Bayes filter \cite{noiseclinic}. The commercial software Neat Image \cite{neatimage} estimates the global noise parameters from a flat region of the given noisy image and filters the noise accordingly. However, both the two methods \cite{crosschannel2016,neatimage} ignore the local statistical property of the noise which is signal dependent and varies in different pixels. By far, real-world image denoising remains a challenging problem in low level vision.  
...
In this work, we propose to lift the SC model to a robust denoiser for real noisy images by utilizing the channel-wise statistics and locally signal dependent property of the real-world noise. Specifically, we propose a trilateral weighted sparse coding (TWSC) scheme for real-world image denoising. Two weight matrices are introduced into the data term of the SC model to characterize the real-world noise property, and another weight matrix is introduced into the regularization term to characterize the sparsity priors of natural images. To solve the proposed TWSC model, we reformulate it into a linear equality-constrained optimization program, which can be minimized under the alternating direction method of multipliers \cite{admm} framework. Theoretical analysis on the existence and uniqueness of the solution of the TWSC model, as well as the convergence of the algorithm, are presented. Experiments on real noisy image datasets demonstrate that the proposed TWSC method achieves much more robust real-world denoising performance than the existing methods.
...
\centering
\vspace{-81mm}
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/LinearScaleConvergence.pdf}}
\vspace{-83mm}
...
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_baboon.png}}
{\footnotesize Clean}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_20_baboon.png}}
{\footnotesize Noisy: 22.11}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_BM3D_20_baboon.png}}
{\footnotesize BM3D: 26.61}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_LSSC_20_baboon.png}}
{\footnotesize LSSC: 26.75}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_NCSR_20_baboon.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_WNNM_20_baboon.png}}
{\footnotesize WNNM: 26.84}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_TNRD_20_baboon.png}}
{\footnotesize TNRD: 26.95}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_DnCNN_20_baboon.png}}
{\footnotesize DnCNN: 27.04}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_WSC_20_baboon.png}}
{\footnotesize WSC: 26.58}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_WLSWSC_20_baboon.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_barbara.png}}
{\footnotesize Clean}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_40_barbara.png}}
{\footnotesize Noisy: 16.09}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_BM3D_40_barbara.png}}
{\footnotesize BM3D: 27.99}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_LSSC_40_barbara.png}}
{\footnotesize LSSC: 28.17}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_NCSR_40_barbara.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_WNNM_40_barbara.png}}
{\footnotesize WNNM: 28.76}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_TNRD_40_barbara.png}}
{\footnotesize TNRD: 27.11}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_DnCNN_40_barbara.png}}
{\footnotesize DnCNN: 27.36}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_WSC_40_barbara.png}}
{\footnotesize WSC: 28.42}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_WLSWSC_40_barbara.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_lena.png}}
{\footnotesize Clean}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_60_lena.png}}
{\footnotesize Noisy: 12.57}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_BM3D_60_lena.png}}
{\footnotesize BM3D: 28.27}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_LSSC_60_lena.png}}
{\footnotesize LSSC: 28.14}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_NCSR_60_lena.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_WNNM_60_lena.png}}
{\footnotesize WNNM: 28.40}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_TNRD_60_lena.png}}
{\footnotesize TNRD: 28.11}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_DnCNN_60_lena.png}}
{\footnotesize DnCNN: 28.53}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_WSC_60_lena.png}}
{\footnotesize WSC: 28.07}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_WLSWSC_60_lena.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_elaine.png}}
{\footnotesize Clean}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_80_elaine.png}}
{\footnotesize Noisy: 10.07}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_BM3D_80_elaine.png}}
{\footnotesize BM3D: 27.16}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_LSSC_80_elaine.png}}
{\footnotesize LSSC: 27.02}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_NCSR_80_elaine.png}}
{\footnotesize NCSR: 26.88}
\end{minipage}
}\vspace{-3mm}
\subfigure{
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_WNNM_80_elaine.png}}
{\footnotesize WNNM: 27.26}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_TNRD_80_elaine.png}}
{\footnotesize TNRD: 26.35}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_DnCNN_80_elaine.png}}
{\footnotesize DnCNN: 26.72}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_WSC_80_elaine.png}}
{\footnotesize WSC: 27.07}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/resize_br_WLSWSC_80_elaine.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/br_monarch.png}}
{\footnotesize Clean}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/br_100_monarch.png}}
{\footnotesize Noisy: 8.10}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/br_BM3D_100_monarch.png}}
{\footnotesize BM3D: 22.52}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/br_LSSC_100_monarch.png}}
{\footnotesize LSSC: 22.24}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/br_NCSR_100_monarch.png}}
{\footnotesize NCSR: 22.13}
\end{minipage}
}\vspace{-3mm}
\subfigure{
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/br_WNNM_100_monarch.png}}
{\footnotesize WNNM: 22.95}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/br_TNRD_100_monarch.png}}
{\footnotesize TNRD: 21.72}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/br_DnCNN_100_monarch.png}}
{\footnotesize DnCNN: 17.13}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/br_WSC_100_monarch.png}}
{\footnotesize WSC: 22.56}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/awgn/br_WLSWSC_100_monarch.png}}
...
\subsection{Results on Real-world Noise Removal}
...
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_Noisy_dog.png}}
{\footnotesize Noisy }
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_CBM3D_dog.png}}
{\footnotesize CBM3D}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_WNNM_dog.png}}
{\footnotesize WNNM}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_TRD_dog.png}}
{\footnotesize TNRD}
\end{minipage}
}\vspace{-3mm}
\subfigure{
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_DnCNN_dog.png}}
{\footnotesize DnCNN}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_NI_dog.png}}
{\footnotesize NI  }
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_NC_dog.png}}
{\footnotesize NC}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_TWSC_dog.png}}
{\footnotesize TWSC}
\end{minipage}
}\vspace{-3mm}
...
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_Noisy_bears.png}}
{\footnotesize Noisy }
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_CBM3D_bears.png}}
{\footnotesize CBM3D}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_WNNM_bears.png}}
{\footnotesize WNNM}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_TRD_bears.png}}
{\footnotesize TNRD}
\end{minipage}
}\vspace{-3mm}
\subfigure{
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_DnCNN_bears.png}}
{\footnotesize DnCNN}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_NI_bears.png}}
{\footnotesize NI  }
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_NC_bears.png}}
{\footnotesize NC}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_TWSC_bears.png}}
{\footnotesize TWSC}
\end{minipage}
}\vspace{-3mm}
...
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_Noisy_frog.png}}
{\footnotesize Noisy }
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_CBM3D_frog.png}}
{\footnotesize CBM3D}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_WNNM_frog.png}}
{\footnotesize WNNM}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_TRD_frog.png}}
{\footnotesize TNRD}
\end{minipage}
}\vspace{-3mm}
\subfigure{
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_DnCNN_frog.png}}
{\footnotesize DnCNN}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_NI_frog.png}}
{\footnotesize NI  }
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_NC_frog.png}}
{\footnotesize NC}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_TWSC_frog.png}}
{\footnotesize TWSC}
\end{minipage}
}\vspace{-3mm}
...
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_Noisy_chinesegirl.png}}
{\footnotesize Noisy }
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_CBM3D_chinesegirl.png}}
{\footnotesize CBM3D}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_WNNM_chinesegirl.png}}
{\footnotesize WNNM}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_TRD_chinesegirl.png}}
{\footnotesize TNRD}
\end{minipage}
}\vspace{-3mm}
\subfigure{
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_DnCNN_chinesegirl.png}}
{\footnotesize DnCNN}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_NI_chinesegirl.png}}
{\footnotesize NI  }
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_NC_chinesegirl.png}}
{\footnotesize NC}
\end{minipage}
\begin{minipage}[t]{0.24\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/nc/resize_br_TWSC_chinesegirl.png}}
{\footnotesize TWSC}
\end{minipage}
}\vspace{-3mm}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_Mean_5dmark3_iso3200_1_real.png}}
{\footnotesize Mean Image}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_Noisy_5dmark3_iso3200_1_real.png}}
{\footnotesize Noisy 37.00}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_CBM3D_5dmark3_iso3200_1_real.png}}
{\footnotesize CBM3D 39.72}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_WNNM_5dmark3_iso3200_1_real.png}}
{\footnotesize WNNM 37.48}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_TRD_5dmark3_iso3200_1_real.png}}
{\footnotesize TNRD 39.46}
\end{minipage}
}\vspace{-3mm}
\subfigure{
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_DnCNN_5dmark3_iso3200_1_real.png}}
{\footnotesize DnCNN 37.26}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_NI_5dmark3_iso3200_1_real.png}}
{\footnotesize NI 37.68}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_NC_5dmark3_iso3200_1_real.png}}
{\footnotesize NC 38.76}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_CCNoise_5dmark3_iso3200_1.png}}
{\footnotesize CC 38.37}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_TWSC_5dmark3_iso3200_1.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_Mean_d600_iso3200_2_real.png}}
{\footnotesize Mean Image}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_Noisy_d600_iso3200_2_real.png}}
{\footnotesize Noisy 33.77}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_CBM3D_d600_iso3200_2_real.png}}
{\footnotesize CBM3D 35.06}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_WNNM_d600_iso3200_2_real.png}}
{\footnotesize WNNM 36.07}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_TRD_d600_iso3200_2_real.png}}
{\footnotesize TNRD 36.34}
\end{minipage}
}\vspace{-3mm}
\subfigure{
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_DnCNN_d600_iso3200_2_real.png}}
{\footnotesize DnCNN 34.48}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_NI_d600_iso3200_2_real.png}}
{\footnotesize NI 35.36}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_NC_d600_iso3200_2_real.png}}
{\footnotesize NC 36.70}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_CCNoise_d600_iso3200_2.png}}
{\footnotesize CC 35.95}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_TWSC_d600_iso3200_2.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_Mean_d800_iso1600_1_real.png}}
{\footnotesize Mean Image}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_Noisy_d800_iso1600_1_real.png}}
{\footnotesize Noisy 35.47}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_CBM3D_d800_iso1600_1_real.png}}
{\footnotesize CBM3D 36.79}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_WNNM_d800_iso1600_1_real.png}}
{\footnotesize WNNM 36.33}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_TRD_d800_iso1600_1_real.png}}
{\footnotesize TNRD 38.07}
\end{minipage}
}\vspace{-3mm}
\subfigure{
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_DnCNN_d800_iso1600_1_real.png}}
{\footnotesize DnCNN 35.79}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_NI_d800_iso1600_1_real.png}}
{\footnotesize NI 37.34}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_NC_d800_iso1600_1_real.png}}
{\footnotesize NC 38.01}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_CCNoise_d800_iso1600_1.png}}
{\footnotesize CC 37.99}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_TWSC_d800_iso1600_1.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_Mean_d800_iso3200_1_real.png}}
{\footnotesize Mean Image}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_Noisy_d800_iso3200_1_real.png}}
{\footnotesize Noisy 33.26}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_CBM3D_d800_iso3200_1_real.png}}
{\footnotesize CBM3D 35.04}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_WNNM_d800_iso3200_1_real.png}}
{\footnotesize WNNM 38.56}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_TRD_d800_iso3200_1_real.png}}
{\footnotesize TNRD 37.66}
\end{minipage}
}\vspace{-3mm}
\subfigure{
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_DnCNN_d800_iso3200_1_real.png}}
{\footnotesize DnCNN 34.08}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_NI_d800_iso3200_1_real.png}}
{\footnotesize NI 36.95}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_NC_d800_iso3200_1_real.png}}
{\footnotesize NC 38.07}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_CCNoise_d800_iso3200_1.png}}
{\footnotesize CC 39.01}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_TWSC_d800_iso3200_1.png}}
...
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_Mean_d800_iso6400_1_real.png}}
{\footnotesize Mean Image}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_Noisy_d800_iso6400_1_real.png}}
{\footnotesize Noisy 29.63}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_CBM3D_d800_iso6400_1_real.png}}
{\footnotesize CBM3D 31.12}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_WNNM_d800_iso6400_1_real.png}}
{\footnotesize WNNM 33.27}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_TRD_d800_iso6400_1_real.png}}
{\footnotesize TNRD 32.80}
\end{minipage}
}\vspace{-3mm}
\subfigure{
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_DnCNN_d800_iso6400_1_real.png}}
{\footnotesize DnCNN 29.83}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_NI_d800_iso6400_1_real.png}}
{\footnotesize NI 31.28}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_NC_d800_iso6400_1_real.png}}
{\footnotesize NC 33.49}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_CCNoise_d800_iso6400_1.png}}
{\footnotesize CC 34.61}
\end{minipage}
\begin{minipage}[t]{0.19\textwidth}
\centering
\raisebox{-0.5cm}{\includegraphics[width=1\textwidth]{images/twsc/cc/resize_br_TWSC_d800_iso6400_1.png}}
